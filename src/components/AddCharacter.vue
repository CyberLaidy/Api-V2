...
<template>
    <div class="create" >
      <h2 style="font-family: 'Courier New', Courier, monospace; margin-bottom: 20px;">Add a new character</h2>
  ...
  <v-form class="input" >
    ...
    <div class="button">
      <button class="button" :onclick="guardar(posts)" method="POST">Guardar</button>
...
export default{
    ...
    computed: {
        ...
        ...mapState(['characters']),
        ...mapActions(['postAddCharacter'])
        //...mapMutations(['postAddCharacter']),
        /**envia acciones al componente */
...
const data = { inputId: " ", inputName: " ", inputStatus: " ", inputSpecies: " ", inputGender: " ",};
addNew(data); */
</script>
